...
public class ListItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListItemDecoration(Drawable divider) { mDivider = divider; }
    ...
    private int getOrientation(RecyclerView parent) {
        ...
        } else throw new IllegalStateException("ListItemDecoration can only be used with a LinearLayoutManager.");
    }
